Contributing to Crypto4Like Core
============================

The Crypto4Like Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Crypto4Like Core project, and is not to be
confused with overall Crypto4Like Network Protocol consensus changes.

Whether a pull request is merged into Crypto4Like Core rests with the project merge
...
Patches that change Crypto4Like consensus rules are considerably more involved than
...
Where a patch set proposes to change the Crypto4Like consensus, it must have been
...
The project leader is the release manager for each Crypto4Like Core release.
