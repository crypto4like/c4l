...
*Setup instructions for a gitian build of Crypto4Like using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Crypto4Like
...
- [Building Crypto4Like](#building-crypto4like)
...
Clone the git repositories for crypto4like and gitian and then checkout the crypto4like version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the crypto4like repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for gitian to work offline.

Building Crypto4Like
----------------

To build Crypto4Like (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the crypto4like repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/crypto4like/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/eastcoastcrypto/Crypto4Like
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Crypto4Like.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit crypto4like=${COMMIT} --url crypto4like=${URL} ../Crypto4Like/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit crypto4like=${COMMIT} --url crypto4like=${URL} ../Crypto4Like/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit crypto4like=${COMMIT} --url crypto4like=${URL} ../Crypto4Like/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/crypto4like-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/crypto4like-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/crypto4like-build.assert
```
