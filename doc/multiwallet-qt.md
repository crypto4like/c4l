...
In order to support loading of multiple wallets in crypto4like-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is crypto4like.cpp.
...
Changes to crypto4like.cpp
----------------------
crypto4like.cpp is the entry point into crypto4like-qt, and as such, will require some minor modifications to provide hooks for
