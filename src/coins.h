...
/** 
    ...
    ****Note - for Crypto4Like we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of crypto4like coming in to a transaction
