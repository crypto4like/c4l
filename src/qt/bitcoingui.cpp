                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Crypto4Like Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Crypto4Like address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and crypto4like: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zC4L"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Crypto4Like Core"), this);
    aboutAction->setStatusTip(tr("Show information about Crypto4Like Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Crypto4Like"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Crypto4Like addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Crypto4Like addresses"));
    ...
    openAction->setStatusTip(tr("Open a Crypto4Like: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Crypto4Like Core help message to get a list with possible Crypto4Like command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Crypto4Like Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Crypto4Like network", "", count));
}
...
{
    QString strTitle = tr("Crypto4Like Core"); // default title
...
/** Creates context menu, its actions, and crypto4likes up all the relevant signals for mouse events. */
