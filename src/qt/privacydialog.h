...
public:
    ...
    void setZCrypto4LikeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzC4L_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzC4L_clicked();
    void on_pushButtonZCrypto4LikeControl_clicked();
