...
/** Utility functions used by the Crypto4Like Qt UI.
 */
namespace GUIUtil
{
...
// Render Crypto4Like addresses in monospace font
...
// Parse "crypto4like:" URI into recipient object, return true on successful parsing
