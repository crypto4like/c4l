...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Crypto4Like Core"),
     ...
     * override -datadir in the crypto4like.conf file in the default data directory
     * (to be consistent with crypto4liked behavior)
     */
    if (dataDir != getDefaultDataDirectory())
