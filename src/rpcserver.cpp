...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Crypto4Like server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Crypto4Like server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Crypto4Like features */
        {"crypto4like", "masternode", &masternode, true, true, false},
        {"crypto4like", "listmasternodes", &listmasternodes, true, true, false},
        {"crypto4like", "getmasternodecount", &getmasternodecount, true, true, false},
        {"crypto4like", "masternodeconnect", &masternodeconnect, true, true, false},
        {"crypto4like", "masternodecurrent", &masternodecurrent, true, true, false},
        {"crypto4like", "masternodedebug", &masternodedebug, true, true, false},
        {"crypto4like", "startmasternode", &startmasternode, true, true, false},
        {"crypto4like", "createmasternodekey", &createmasternodekey, true, true, false},
        {"crypto4like", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"crypto4like", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"crypto4like", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"crypto4like", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"crypto4like", "getmasternodescores", &getmasternodescores, true, true, false},
        {"crypto4like", "mnbudget", &mnbudget, true, true, false},
        {"crypto4like", "preparebudget", &preparebudget, true, true, false},
        {"crypto4like", "submitbudget", &submitbudget, true, true, false},
        {"crypto4like", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"crypto4like", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"crypto4like", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"crypto4like", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"crypto4like", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"crypto4like", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"crypto4like", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"crypto4like", "checkbudgets", &checkbudgets, true, true, false},
        {"crypto4like", "mnsync", &mnsync, true, true, false},
        {"crypto4like", "spork", &spork, true, true, false},
        {"crypto4like", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"crypto4like", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use crypto4liked, or the -server option to crypto4like-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> crypto4like-cli " + methodname + " " + args + "\n";
}
