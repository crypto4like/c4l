...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Crypto4Like Core crypto4like-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  crypto4like-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded crypto4like transaction") + "\n" +
                               "  crypto4like-tx [options] -create [commands]   " + _("Create hex-encoded crypto4like transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded crypto4like transaction
