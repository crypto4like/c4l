...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 CRYPTO4LIKE at the same time
    ONLY_10000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                          // UTXO's that are valid for staking
};

// Possible states for zC4L send
enum ZerocoinSpendStatus {
    ZCRYPTO4LIKE_SPEND_OKAY = 0,                            // No error
    ZCRYPTO4LIKE_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZCRYPTO4LIKE_WALLET_LOCKED = 2,                         // Wallet was locked
    ZCRYPTO4LIKE_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZCRYPTO4LIKE_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZCRYPTO4LIKE_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZCRYPTO4LIKE_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZCRYPTO4LIKE_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZCRYPTO4LIKE_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZCRYPTO4LIKE_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZCRYPTO4LIKE_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZCRYPTO4LIKE_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZCRYPTO4LIKE_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZCRYPTO4LIKE_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZCRYPTO4LIKE_SPENT_USED_ZCRYPTO4LIKE = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZCrypto4LikeAutoBackups(bool fEnabled)
    {
