...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Crypto4Like is not connected
    ...
    RPC_WALLET_PASSCRYPTO4LIKEASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
