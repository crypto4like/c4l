...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000ed2f13656360a155e85214769d6a7d73af9ea70c6050fd278ce7874dd84"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1546919281, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0434e299a6f90ceef511478cd29de1f3a5864c8463a0affbff87f335d3ff493967ab0bed8ba5ca83817381bab41d6206dc11f73d50c7cd121c9fdc88f970828a03");
        nDefaultPort = 53388;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Crypto4Like starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1646919281;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint
        const char* pszTimestamp = "Crypto4Like - Happy New Year 2019";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0496d91b601ee4306a4675e65945e8dd63a5828c3773ebf4b89834742052db1686aab5d779c0c0aa6a670ebdba75e9befce214382f5c01a0549f082d25a1ecdd11") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1546919281;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2909883;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000ed2f13656360a155e85214769d6a7d73af9ea70c6050fd278ce7874dd84"));
        assert(genesis.hashMerkleRoot == uint256("0x5d677d194e663cea6ba35e75ff089138d3141684d74fc03de78b9560695cb44f"));

	vSeeds.push_back(CDNSSeedData("76.74.170.27", "76.74.170.27"));
        vSeeds.push_back(CDNSSeedData("69.90.132.156", "69.90.132.156"));
        vSeeds.push_back(CDNSSeedData("76.74.177.224", "76.74.177.224"));
	...
	strSporkKey = "049DE506621C792450D6D76687517D846EBEF5E043EA449640F207C30B16D88AB67BF0D1536F2B8691C4779C4FD10DB99178E9C2B10B6D74B81C4B470A5B38C688";
        strObfuscationPoolDummyAddress = "CXFxsqTAy8FiwGKzQnAKfpNgfXBc5CXALN";
        nStartMasternodePayments = 1546919281;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Crypto4Like: 1 day
        nTargetSpacing = 1 * 60;  // Crypto4Like: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet crypto4like addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet crypto4like script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet crypto4like BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet crypto4like BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet crypto4like BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Crypto4Like: 1 day
        nTargetSpacing = 1 * 60;        // Crypto4Like: 1 minutes
